...
class UserInfo(commands.Cog):
     ...
     async def userinfo(self, ctx, user: Option(discord.Member, "Specify a user", default=None)):
         ...
         embed.add_field(name='Nickname', value=f'{(user.nick if user.nick else "Not set")}', inline=False)
         ...
         embed.add_field(name='Bot', value=f'{("Yes" if user.bot else "No")}', inline=False)
         ...
         embed.add_field(name='Booster', value=f'{("Yes" if user.premium_since else "No")}', inline=False)
