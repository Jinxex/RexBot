...
class Clear(commands.Cog):
    ...
    async def clear(self, ctx, amount: int):
        ...
        if amount > 100:
            await ctx.blitz("Du kannst nicht mehr als 100 Nachrichten auf einmal löschen!")
        else:
            count_members = {}
            messages_deleted = 0
            ...
            await ctx.respond(f'Es wurden {messages_deleted} Nachrichten gelöscht :white_check_mark: !\n\n{final_string}', ephemeral=True)
